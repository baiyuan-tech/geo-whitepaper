...
### 6.10.2 `seedBrandRAGKB`：AXP 有効化時の KB 自動作成とシード
...
### 6.10.3 キーワード注入：ブランドの声を AXP コンテンツに
...
|---------|------------|-------------|--------------|------------|
| 百原GEO | 13 | pricing_summary | 9/13 | 11–13/13 |
| 百原RAG知識庫 | 12 | pricing_summary | 7/12 | 11–12/12 |
| 愛上生活 | 10 | pricing_summary | 7/10 | 9–10/10 |
| PIF | 12 | faq / pricing | 7/12 | 10–12/12 |
| 百原科技有限公司 | 10 | pricing_summary | 1/10 ★ | 9–10/10 |

★ ブランド公式サイトに公開定価ページがないため、RAG が推測を正しく拒否。低カバレッジは想定内の動作。

### 6.10.4 `content_preview`：ページごとの品質監視シグナル
